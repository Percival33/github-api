...
I've used [FastAPI](https://fastapi.tiangolo.com/) to create this project. <br/>I assumed that API will be used on local machine, so every sent request is sent as authenticated if credencials are passed in a file.
